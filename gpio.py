...
gpioPin02 = 10 # Broadcom pin 02 (Pi pin )
gpioPin03 = 11 # Broadcom pin 03 (Pi pin )
gpioPin04 = 12 # Broadcom pin 04 (Pi pin )
gpioPin01 = 13 # Broadcom pin 01 (Pi pin )
gpioPin02 = 14 # Broadcom pin 02 (Pi pin )
gpioPin03 = 15 # Broadcom pin 03 (Pi pin )
gpioPin01 = 16 # Broadcom pin 01 (Pi pin )
gpioPin02 = 17 # Broadcom pin 02 (Pi pin )
gpioPin03 = 18 # Broadcom pin 03 (Pi pin )
gpioPin04 = 19 # Broadcom pin 04 (Pi pin )
...
GPIO.setup(gpioPin22, GPIO.OUT)

try:
    while 1:
        GPIO.output(gpioPin21,GPIO.HIGH)
        GPIO.output(gpioPin22,GPIO.HIGH)
        print ("LED ON")
        time.sleep(3)
        GPIO.output(gpioPin21, GPIO.LOW)
        GPIO.output(gpioPin22, GPIO.LOW)
        print ("LED OFF")
        time.sleep(3)
